...
namespace dmitrygrasevich\imperavi;
 ...
 *
 * @link https://github.com/dmitry-grasevich/yii2-imperavi-widget
 * @link http://imperavi.com/redactor
 * @license https://github.com/dmitry-grasevich/yii2-imperavi-widget/blob/master/LICENSE.md
 */
class Widget extends BaseWidget
{
    /** Name of inline JavaScript package that is registered by the widget */
    const INLINE_JS_KEY = 'dmitrygrasevich/imperavi/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['dmitrygrasevich/imperavi']) && !isset(Yii::$app->i18n->translations['dmitrygrasevich/imperavi/*'])) {
            Yii::$app->i18n->translations['dmitrygrasevich/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@dmitrygrasevich/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'dmitrygrasevich/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
